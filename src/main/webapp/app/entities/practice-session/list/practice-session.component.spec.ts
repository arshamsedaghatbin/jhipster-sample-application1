...
describe('Component Tests', () => {
  describe('PracticeSession Management Component', () => {
    let comp: PracticeSessionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PracticeSessionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.practiceSessions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });

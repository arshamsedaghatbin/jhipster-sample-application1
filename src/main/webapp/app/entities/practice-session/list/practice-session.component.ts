...
export class PracticeSessionComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.practiceSessionService
      ...
      .subscribe(
        (res: HttpResponse<IPracticeSession[]>) => {
  ...
  trackId(index: number, item: IPracticeSession): number {
    return item.id!;
  }

  delete(practiceSession: IPracticeSession): void {
    const modalRef = this.modalService.open(PracticeSessionDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.practiceSession = practiceSession;
  ...
  protected onSuccess(data: IPracticeSession[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

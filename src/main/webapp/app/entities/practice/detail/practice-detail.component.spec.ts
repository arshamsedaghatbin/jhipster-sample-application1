...
describe('Component Tests', () => {
  describe('Practice Management Detail Component', () => {
    let comp: PracticeDetailComponent;
        ...
        providers: [
          {
            ...
            useValue: { data: of({ practice: { id: 123 } }) },
          },
        ],
      })
    ...
    describe('OnInit', () => {
      it('Should load practice on init', () => {
        // WHEN
        comp.ngOnInit();

        // THEN
        expect(comp.practice).toEqual(expect.objectContaining({ id: 123 }));
      });
    });
